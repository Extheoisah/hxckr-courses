...
<Step step='1' title='Clone the Repository'>
  <Terminal>git clone $REPO_URL</Terminal>
</Step>
...
<Text>After pushing the empty commit, you should see a message indicating that the commit was pushed successfully.</Text>

</ContentBox>

<GitPushContainer>
    <GitPushText content="Listening for push events..." moduleNumber={2} />

    <GitPushButton title="Continue to next stage" link="/module-3/instructions" moduleNumber={2} />
